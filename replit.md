...
Single `prospects` table: id, company_name, role_title, job_url, status, interest_level, notes, salary (integer, optional, annual USD), hiring_manager_email (text, optional), created_at.
